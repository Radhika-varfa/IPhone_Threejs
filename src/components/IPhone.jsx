...
function Model(props) {
  ...
  Object.entries(materials).map((materials) => {
    if(
    materials[0] !== "zFdeDaGNRwzccye" &&
    materials[0] !== "ujsvqBWRMnqdwPx" &&
    materials[0] !== "hUlRcbieVuIiOXG" &&
    materials[0] !== "jlzuBkUzuJqgiAK" &&
    materials[0] !== "xNrofRCqOXXHVZt" 
  ){
    materials[1].color = new THREE.Color(props.item.color[0]);
  }
